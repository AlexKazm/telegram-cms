...
$.extend( Buttons.prototype, {
	...
	/**
	 * Add a new button to the key press parser
	...
	/**
	 * Remove a key from the key parser for this instance (to be used when a
	 * button is removed)
	...
	_popover: function ( content, hostButton, inOpts ) {
		...
		// This is bonkers, but if we don't have a click parser on the
		// background element, iOS Safari will ignore the body click
		// parser below. An empty function here is all that is
